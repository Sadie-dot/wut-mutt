            ...
            HStack(spacing: 6) {
                ...
                Button {
                    ...
                    Text("Credits & disclosures")
                        .underline()
                        // 44pt tap target per the handoff, pulled back out of
                        // the layout so the footer keeps its 28pt design height.
                        .padding(.vertical, 14)
                ...
                ScrollView {
                    ...
                    VStack(spacing: 8) {
                        Text("CAST — TONIGHT'S STARS")
                            ...
                            .kerning(3)
                            .foregroundColor(.wmPink)
                        // Line spacing set to the design's line-heights —
                        // 1.9 on the cast list, 1.7 on the fine print.
