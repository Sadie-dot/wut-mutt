...
- But never guess WHICH cross: the poodle crosses mostly differ by size and coat color, and a Cockapoo misread as a Labradoodle is exactly the failure this rule exists to prevent. Name a specific cross only when you are genuinely certain which one it is; otherwise bill the visible parent (Poodle) and give the mystery to the Guest Star — the wrong variant on a card is worse than an honest mystery.
