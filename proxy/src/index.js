...
- The small fluffy companions (Havanese, Lhasa Apso, Shih Tzu, Maltese, Coton de Tulear, and kin) are near-identical under a haircut: grooming changes their look more than breed does. Name a specific one only when the read is genuinely clear; otherwise bill the closest single match and give the rest of the doubt to the Guest Star. Never bill several of them together — that is one fluffy signal counted twice.
