...
- "certainty" is 40-99: how confident the visual breed read is. It must agree with the cast: 80+ only when the read is clean — a purebred or an unmistakable mix; a hedged cast (the Guest Star holding 20+ or no breed reaching half) belongs in the 60s and 70s; and a cast the Guest Star leads — or holds 40 or more of — is a 40-59 read: certainty in the 40s or 50s, never higher — that much of the cast unnamed is a shrug, and naming no breed while claiming confidence is the one combination that cannot be true.
